...
public class Pedido {
    ...
    @JoinColumn(
            name = "cli_id",
            nullable = false,
            foreignKey = @ForeignKey(name = "ped_fk_cli_id")
    )
    ...
    @JoinColumn(
            name = "mesa_id",
            nullable = false,
            foreignKey = @ForeignKey(name = "ped_fk_mesa_id")
    )
    private Mesa mesa;
    ...
    @JoinColumn(
            name = "fun_id",
            nullable = false,
            foreignKey = @ForeignKey(name = "ped_fk_fun_id")
    )
    ...
    @JoinColumn(
            name = "itp_id",
            nullable = false,
            foreignKey = @ForeignKey(name = "ped_fk_itp_id")
    )
